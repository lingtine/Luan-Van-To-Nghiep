      ...
      <div className="container mx-auto pt-20">
        <div className="flex flex-wrap -mx-8 mb-2">
          ...
          <div className="flex-[0_0_100%] px-8 max-w-full md:flex-[0_0_50%] md:max-w-[50%] lg:max-w-[25%] lg:flex-[0_0_25%]">
            ...
            <ul className="text-dark-border-subtle text-sm gap-2 flex flex-col">
          ...
          <div className="flex-[0_0_100%] px-8 max-w-full md:flex-[0_0_50%] md:max-w-[50%] lg:max-w-[25%] lg:flex-[0_0_25%]">
            ...
            <ul className="text-dark-border-subtle text-sm flex flex-col gap-2">
          ...
          <div className="flex-[0_0_100%] px-8 max-w-full md:flex-[0_0_50%] md:max-w-[50%] lg:max-w-[25%] lg:flex-[0_0_25%]">
            <div className="my-2">
              <h5 className="text-white font-bold text-lg">Liên kết nhanh</h5>
            </div>
            <ul className="text-dark-border-subtle flex flex-col gap-2">
