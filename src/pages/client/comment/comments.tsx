...
export default function Comments() {
  const mockUp = Array.from({ length: 7 }, (_, index) => (
          ...
          <div className="flex justify-center items-center space-x-2">
            <div className="bg-gray-100 w-auto rounded-xl px-2 pb-2">
              ...
              <div className="text-xs">
                ...
                adipisicing elit. Expedita, maiores! Lorem ipsum, dolor sit amet
                consectetur adipisicing elit. Expedita, maiores!
              </div>
            </div>
  ...
  return (
    <div className=" w-[70%] sm:max-w-7xl  h-auto  px-6 py-2 flex flex-col space-y-2 shadow rounded-lg">
      {mockUp}
    </div>
  );
}
