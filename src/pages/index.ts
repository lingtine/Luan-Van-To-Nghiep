//admins page
export { default as BrandPage } from "./admin/brand/brand";
export { default as AddBrandPage } from "./admin/brand/add-brand";
export { default as CategoryAdminPage } from "./admin/category/category";
export { default as AddCategoryPage } from "./admin/category/add-category";
export { default as CategoryGroupPage } from "./admin/category-group/category-group";
export { default as AddCategoryGroupPage } from "./admin/category-group/add-category-group";
...
export { default as ReportWarehousePage } from "./admin/statistical/report-warehouse";
